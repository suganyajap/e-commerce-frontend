      ...
      <>
        <MainContainer>
          <InnerContainer>
            <Left>
              <div>
                <h2 style={{ textAlign: "start" }}>Beauty Prism</h2>
              </div>
              <div>
                <p style={{ padding: "5px" }}>
            ...
            <Right>
              ...
              <div>
                <p>
                  <LocationCity /> Bangalore,Karnataka.
                </p>
              </div>
              <div>
                <p>
                  <Email /> suganyajap@gmail.com
                </p>
              </div>
              <div>
                <p>
        ...
        <OwnerDiv>
          <div className="p-2"> Developed by Sundaravadivu</div>
          <div className="d-flex gap-1  ">
            <div>
              <EmailOutlined />
              suganyajap@gmail.com
            </div>
